...
if (mode) {
    $.activityUrl = 'https://cjhy-isv.isvjcloud.com/wx/completeInfoActivity/view/activity?activityId=009b8d77c8af40bd9ad3cbc7c9e09cf3&venderId=1000089246'
    $.activityUrl = 'https://lzkj-isv.isvjcloud.com/prod/cc/interactsaas/index?activityType=10049&templateId=20210720190900wsxxyl011&activityId=1622897703159136257&nodeId=101001009&prd=cjwx&shareuserid4minipg=ixaKACMHzt107D3uPA8WcPkaL5GGqMTUc8u/otw2E+a7Ak3lgFoFQlZmf45w8Jzw&shopid=1000392887'
    ...
    $.activityUrl = 'https://cjhy-isv.isvjcloud.com/wx/completeInfoActivity/view/activity?activityId=162dc72596d2418c9b141b103b7b62fb&venderId=1000374674'
...
class Task extends Env {
    ...
    async exec() {
        ...
        if (this.isJinggengAct) {
            let data = await this.api("ql/front/postAddMaterial",
                `user_id=${$.userId}&act_id=${$.activityId}&detail=${encodeURIComponent(JSON.stringify({
        ...
        .join('&');
        //name=${}&phone=${}&gender=${}&birthDay=&professional=${}&customContent=&
        // let prize = await this.api('wx/completeInfoActivity/save', Object.fromEntries(map));
