...
if (mode) {
    $.activityUrl = 'https://lzkj-isv.isvjcloud.com/prod/cc/interactsaas/index?activityType=10054&activityId=1780190943865262082&templateId=20210804190900ssq011&nodeId=101001054&prd=cjwx&adsource=tg_storePage'
    $.activityUrl = 'https://lzkj-isv.isvjcloud.com/drawCenter/activity/042762ab91a74b0d83745a8a2b0ce85d?activityId=042762ab91a74b0d83745a8a2b0ce85d&adsource=tg_storePage'
    $.maxCookie = 5
}
...
class Task extends Env {
    ...
    async getPrizeList(context) {
        if (this.isCommonAct) {
            let prizeList = await this.api('drawCenter/getPrizeList',
    ...
    async exec() {
        ...
        //助力暂且不弄
        let activityContent = await this.api('drawCenter/activityContent',
        ...
        activityContent = await this.api('drawCenter/activityContent',
