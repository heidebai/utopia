        ...
        if (this.isV1Act) {
            ...
            if ($.open) {
                ...
                if (recordData?.data) {
                    ...
                    //await this.wxStop(recordData.errorMessage)
                }
                return
            }
            ...
            //await this.wxStop(quickAddCart.resp_msg)
        } else {
            let activityContent = await this.api('wxCartKoi/cartkoi/activityContent',
            ...
            // await this.checkActivity(null)

            //超过自动开奖
            if ($.open) {
                //自动填地址
                let recordData = await this.api('wxCartKoi/cartkoi/drawResult',
            ...
            let quickAddCart = await this.api('wxCartKoi/cartkoi/quickAddCart',
            ...
            //await this.wxStop(quickAddCart.errorMessage)
