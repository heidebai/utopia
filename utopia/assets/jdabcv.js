...
function getJdabcv() {
    ...
    return '__jda='.concat(cookies['__jda'].value).concat('; __jdb=').concat(cookies['__jdb'].value).concat('; __jdc=').concat(cookies['__jdc'].value).concat('; __jdv=').concat(cookies['__jdv'].value).concat('; mba_muid='.concat(cookies['mba_muid'].value)).concat(";");
}

module.exports = {getJdabcv}